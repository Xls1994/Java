...
public class EntityMemNN_Position_1_Main {
	...
	public EntityMemNN_Position_1_Main(String modelFile) throws Exception
	{
	...
	public EntityMemNN_Position_1_Main() throws Exception
	{ 
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			SentenceEntityMemNN_Position_1 memNN = new SentenceEntityMemNN_Position_1(
					wordIds,
					wordPositions,
					seedLookup,
					attentionCellSeed,
...
//		writer.close();
	...
	public void dumpAttentionWeights(
			SentenceEntityMemNN_Position_1 memNN,
	...
	public static void main(String[] args) throws Exception
	{
		...
		EntityMemNN_Position_1_Main main = new EntityMemNN_Position_1_Main();
...
//		String modelFile = "model/Restaurant-hop6-position-2-model2--32.model";
//		EntityMemNN_Position_1_Main main = new EntityMemNN_Position_1_Main(modelFile);
//		main.predict(modelFile);
//		-roundNum 1000 -numberOfHops 1 -learningRate 0.01 -probThreshold 0.15 -classNum 4 -attentionCellRandomBase 0.01 -entityTransferRandomBase 0.01 -embeddingLength 50 -randomizeBase 0.01 -trainFile /home/laboratory/memoryCorpus/laptops_train.xml.seg.addConf -testFile /home/laboratory/memoryCorpus/laptops_trial.xml.seg.addConf -embeddingFile /home/laboratory/memoryCorpus/en_vectors_50.txt -modelFile  /home/laboratory/memoryCorpus/model_1 -accuracyThreshold 0.25
	}
}
