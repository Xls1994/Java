...
public class EntityMemNN_Position_3_Main {
	...
	public EntityMemNN_Position_3_Main(String modelFile) throws Exception
	{
	...
	public EntityMemNN_Position_3_Main() throws Exception
	{ 
...
//				System.err.println("targetIds.length == 0 || forwWordIds.length == 0");
			...
			SentenceEntityMemNN_Position_3 memNN = new SentenceEntityMemNN_Position_3(
					wordIds,
					seedPositionLookup,
					wordPositions,
					seedLookup,
...
//		writer.close();
	...
	public static void main(String[] args) throws Exception
	{
		...
		EntityMemNN_Position_3_Main main = new EntityMemNN_Position_3_Main();
